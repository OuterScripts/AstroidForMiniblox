...
(function() {
	...
	// https://stackoverflow.com/questions/22141205/intercept-and-alter-a-sites-javascript-using-greasemonkey - injection
	if(navigator.userAgent.indexOf("Firefox") != -1) // check if the useragent is firefox because firefox needs a different injection method
	{
	...
	else // uhhhhh, it uses a different injection method
	{
